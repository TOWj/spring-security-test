...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.authorizeRequests()// Сначала конфигурируем авторизацию, теперь все запросы сначала пройдут через авторизацию
                .antMatchers("/admin").hasRole("ADMIN")// Настраиваем роли здесь, доступ к странице admin только админу
                ...
                .anyRequest().hasAnyRole("USER", "ADMIN")// Для всех остальных запросов от таких ролей
